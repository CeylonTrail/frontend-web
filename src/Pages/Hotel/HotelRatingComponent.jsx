...
const HotelRatingComponent = () => {
  // Initial total rating and number of ratings
  const initialTotalRating = 15.0; // Example initial total rating (sum of ratings)
  const initialNumRatings = 3; // Example initial number of ratings
...
export default HotelRatingComponent;
