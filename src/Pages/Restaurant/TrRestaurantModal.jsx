...
const TrRestaurantModal = ({ isOpen, onRequestClose, foodDetails = {} }) => {
  ...
  const {
    title = "Fooooooood",
    description = "dgdhfdshbdfjndgbcvbgfnghgdhdghdhdfh",
    price = "250",
    rating = "4.5",
  } = foodDetails;
            ...
            <div className="modal-body">
              ...
              <div className="form-group">
                ...
                >
                  ...
                  >
                    <h3 className="form-label">Rate this:</h3>
...
export default TrRestaurantModal;
