...
export default function Header(prop) {
    ...
    const [aboutPath, setAboutPath] = useState("/landing");
    ...
    return (
        <nav className={`bg-SecondaryLight pb-5 md:text-sm ${state ? "shadow-lg rounded-xl border mx-2 mt-2 md:shadow-none md:border-none md:mx-2 md:mt-0" : ""}`}>
